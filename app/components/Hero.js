  ...
  return (
      <div className="bg-black ">
        <div className="relative isolate overflow">
          ...
          <CldImage className="absolute inset-0 -z-10 h-full w-full object-cover object-center opacity-75 rounded-t-lg"
                    // defaultImage="istanbul"
                    src={content.background_image[0].public_id}
                    width="2048"
                    height="768"
                    alt={content.header}
          />
